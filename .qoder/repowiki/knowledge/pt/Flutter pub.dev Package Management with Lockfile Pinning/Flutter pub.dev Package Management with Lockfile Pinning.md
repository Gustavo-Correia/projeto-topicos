...
**Arquivos chave**
- `pubspec.yaml` — fonte única de verdade para dependências declaradas (`provider`, `hive`, `hive_flutter`, `intl`, `uuid`, `cupertino_icons`) e ferramentas de dev (`flutter_lints`, `flutter_launcher_icons`).
